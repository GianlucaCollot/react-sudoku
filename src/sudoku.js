...
export class sudoku {
  ...
  static DIGITS = "123456789";    // Allowed this.DIGITS
  static NR_SQUARES = 81;            // Number of squares
  static ROWS = "ABCDEFGHI";         // Row lables
  static COLS = this.DIGITS;       // Column lables
  static SQUARES = null;             // Square IDs
  static UNITS = null;               // All units (row, column, or box)
  static SQUARE_UNITS_MAP = null;    // Squares -> units map
  static SQUARE_PEERS_MAP = null;    // Squares -> peers map
  ...
  // Generate
  // -------------------------------------------------------------------------
  static generate(difficulty, unique) {
  ...
  static _get_candidates_map(board) {
  ...
  static _search(candidates, reverse) {
  ...
  static _assign(candidates, square, val) {
  ...
  static _eliminate(candidates, square, val) {
  ...
  static _get_square_vals_map(board) {
  ...
  static _get_square_units_map(squares, units) {
  ...
  static _get_square_peers_map(squares, units_map) {
  ...
  static _get_all_units(rows, cols) {
  ...
  // Conversions
  // -------------------------------------------------------------------------
  static board_string_to_grid(board_string) {
  ...
  static board_grid_to_string(board_grid) {
  ...
  static _force_range(nr, max, min) {
